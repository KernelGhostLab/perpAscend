...
const MOCK_CONFIG_PUBKEY = new PublicKey('So11111111111111111111111111111111111111112');
const MOCK_QUOTE_MINT = new PublicKey('EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v'); // USDC on devnet  
const MOCK_ORACLE_PUBKEY = new PublicKey('So11111111111111111111111111111111111111113');
  ...
  async getMarkets(): Promise<RealMarket[]> {
    try {
      ...
      return [
        {
          symbol: 'SOL',
          address: new PublicKey('So11111111111111111111111111111111111111112'), // SOL mint
          price: 180.50,
          change24h: 5.2,
          fundingRate: 0.01,
        ...
        {
          symbol: 'ETH',
          address: new PublicKey('7vfCXTUXx5WJV5JADk17DUJ4ksgau7utNKj4b963voxs'), // ETH mint on Solana
          price: 3200.75,
          change24h: -2.1,
          fundingRate: -0.005,
          openInterest: 800000,
